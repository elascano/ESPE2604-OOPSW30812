...
CONNECTION_STRING = "mongodb+srv://Jennyfer:jennyfer@jennyfer.owlaicw.mongodb.net/?appName=Jennyfer"
...
class FarmSystemApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Farm Animal System")
    ...
    def show_home(self):
        ...
        lbl_welcome = tk.Label(self.main_container, text="Welcome To Farm Animal System", font=("Arial", 18, "bold"))
    ...
    def show_chicken_frame(self):
        self.clear_container()
        tk.Label(self.main_container, text="Chicken Management", font=("Arial", 14, "bold")).pack(pady=10)
