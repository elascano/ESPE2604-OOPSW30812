from ec_edu_espe.model.bubble_sort import BubbleSort
from ec_edu_espe.model.insertion_sort import InsertionSort 
from ec_edu_espe.model.quick_sort import QuickSort
