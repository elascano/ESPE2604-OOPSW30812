...
from controller.arithmetic_tool import ArithmeticTool

class TestArithmeticTool(unittest.TestCase):
    ...
    def test_add(self):
        ...
        for addend1, addend2, expected in add_cases:
            ...
            with self.subTest(msg=f"Scenario: {addend1} + {addend2}"):
                ...
                self.assertAlmostEqual(ArithmeticTool.add(addend1, addend2), expected, places=3)
    ...
    def test_subtract(self):
        ...
        for minuend, subtrahend, expected in subtract_cases:
            with self.subTest(msg=f"Scenario: {minuend} - {subtrahend}"):
                ...
                self.assertAlmostEqual(ArithmeticTool.subtract(minuend, subtrahend), expected, places=3)
