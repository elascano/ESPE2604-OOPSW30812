...
class ProductModel:
    ...
    def read_catalog(self):
        """Returns the available products to choose from."""
        try:
    ...
    def calculate_item_values(self, base_price):
        """Calculates 15% VAT and the total for a single selected product."""
    ...
    def calculate_list_totals(self, chosen_products):
        """Calculates the subtotal, VAT, and net total exclusively for selected items."""
