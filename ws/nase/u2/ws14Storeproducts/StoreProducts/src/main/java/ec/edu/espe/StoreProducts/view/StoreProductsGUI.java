...
public class StoreProductsGUI extends JFrame {
    ...
    public StoreProductsGUI() {
        ...
        cmbProducts.addItem("Doritos");
        cmbProducts.addItem("Cake");
        cmbProducts.addItem("Pallets");
        cmbProducts.addItem("Ice cream");
        cmbProducts.addItem("chewing gum");
        cmbProducts.addItem("Drinks");
        cmbProducts.addItem("Donuts");
