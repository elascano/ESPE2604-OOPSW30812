 ...
 * @author LABS-ESPE
 */
public class FirmCustomer extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(FirmCustomer.class.getName());
    ...
    private void initComponents() {
        ...
        btmCancel.addActionListener(this::btmCancelActionPerformed);

        ButtonQuit.setText("Quit");
        ButtonQuit.addActionListener(this::ButtonQuitActionPerformed);

        btmMenu.setText("Menu");
        btmMenu.addActionListener(this::btmMenuActionPerformed);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new FirmCustomer().setVisible(true));
    }
